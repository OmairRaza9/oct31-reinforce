...
if doc_rating >= 4
  ...
  # If they rate just comedies 4 or higher, recommend the comedy. Otherwise, recommend a good book.
elsif comedy_rating >= 4 && drama_rating <= 4 && doc_rating <=4
  puts "I recomend you watch the comedy #{comedy}"
else comedy_rating <= 4 && drama_rating <= 4 && doc_rating <=4
